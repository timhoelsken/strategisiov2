...
public class Team {
   ...
   *
   * @param anItem
   * @return true if Game should be ended, false if not
   */
  public boolean removeItemFromTeam(Item anItem) {
    ...
    // TODO consider if also Flag should be removed.
    // TODO consider if boolean return values are state of the art
